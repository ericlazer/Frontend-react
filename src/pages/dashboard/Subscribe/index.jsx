  ...
  return (
    <div className='block lg:flex justify-between mt-32 px-0 md:px-24'>
      <div className='text-center lg:text-left'>
        <p className="text-[32px] xl:text-[56px] font-semibold leading-[60px] text-white">Subscribe to <br /> new letter</p>
      ...
      <div className='flex flex-col gap-4 text-white w-full lg:w-[520px] mt-4 lg:mt-0'>
        ...
        <div className='py-4 rounded-md duration-300 transition cursor-pointer ease-in-out text-[14px] hover:opacity-[0.8] w-[80%] sm:w-[300px] text-center mx-auto' style={{background: 'radial-gradient(100% 341.37% at 0% 24.29%, #5C1693 0%, #201DAD 100%)'}}>Ged Started</div>
      </div>
    </div>
  )
}
